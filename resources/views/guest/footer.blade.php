            ...
            <div class="row">
                ...
                <div class="col-lg-5 col-md-5 col-sm-6 col-xs-12">
                    <figure class="subscribe_image mb-0">
                        <img src="{{ asset('vedharanyam/assets/images/subscribe_image.png') }}" alt="">
                    </figure>
                </div>
            </div>
        </div>
...
<section class="footer-section">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 d-lg-block d-none">
                    <div class="footer_logo">
                        <a href="index.html" class="text-decoration-none"><figure class="mb-0"><img src="{{ asset('vedharanyam/assets/images/footer_logo.png') }}" alt="" class="img-fluid"></figure></a>
                    </div>
                </div>
                    ...
                    <div class="contact_col">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li class="contact_icons">
                                ...
                                <a href="mailto:Info@Vedaranyam.om" class="text-decoration-none">Info@Vedaranyam.om</a>
                            </li>
                            <li class="mb-0">
    ...
    <div class="bottom-portion">
        <div class="copyright col-xl-12"> 
            <p>Copyright 2022, Vedaranyam.com All Rights Reserved.</p>
        </div>
    </div>
    <div class="footer_shape right_shape">
        <figure class="mb-0"><img src="{{ asset('vedharanyam/assets/images/footer_shape.png') }}" alt="" class="img-fluid"></figure>
    </div>
</section>
<!-- Latest compiled JavaScript -->
<script src="{{ asset('vedharanyam/assets/js/jquery-3.6.0.min.js') }}"></script>
<script src="{{ asset('vedharanyam/assets/js/popper.min.js') }}"></script>
<script src="{{ asset('vedharanyam/assets/js/video-popup.js') }}"></script>
<script src="{{ asset('vedharanyam/assets/js/bootstrap.min.js') }}"></script>
<script src="../../unpkg.com/aos%402.3.1/dist/aos.js"></script>
<script src="{{ asset('vedharanyam/assets/js/video-section.js') }}"></script>
<script src="{{ asset('vedharanyam/assets/js/animation.js') }}"></script>
<script src="https://unpkg.com/ityped@0.0.10"></script>
<script src="{{ asset('vedharanyam/assets/js/type.js') }}"></script>
</body>
