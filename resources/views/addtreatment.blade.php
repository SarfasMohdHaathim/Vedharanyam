                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        @else
                                            <h4 class="font-size-18">Add Treatment</h4>
                                        @endif
                                        </div>
                                        ...
                                        <form method="POST" action="{{ route('treatments.store') }}" enctype="multipart/form-data">
                                            @csrf
                                        <div class="mb-3 row">
                                            <label for="example-text-input" class="col-md-2 col-form-label">Treatment Name</label>
                                            <div class="col-10 col-md-6">
                                                <input class="form-control" type="text" id="example-text-input" name="name" value="{{ old('name') }}">
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                            <label for="example-url-input" class="col-md-2 col-form-label">Treatment Thumbnail</label>
                                            <div class="col-10 col-md-6">
                                        ...
                                        <div class="mb-3 row">
                                            <label class="col-md-2 col-form-label">Treatment Category</label>
                                            <div class="col-10 col-md-6">
                                                <select class="form-select" name="category">
                                                    <option value="">Select Treatment Category</option>
                                                    <option value="Back and Neck" {{ old('category') === 'Back and Neck' ? 'selected' : '' }}>Back and Neck</option>
                                                    <option value="Lifestyle Diseases" {{ old('category') === 'Lifestyle Diseases' ? 'selected' : '' }}>Lifestyle Diseases</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                            <label for="example-url-input" class="col-md-2 col-form-label">Treatment Details</label>
